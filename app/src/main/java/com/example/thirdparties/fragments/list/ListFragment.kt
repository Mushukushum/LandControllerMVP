...
import com.example.thirdparties.fragments.update.UpdateFragmentDirections
...
class ListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        //SoilConditionViewModel
        soilConditionViewModel = ViewModelProvider(this).get(SoilConditionViewModel::class.java)
        soilConditionViewModel.readAllData.observe(viewLifecycleOwner, Observer {
